...
crontab.scheduleJob("00 0 9 * * 1-5", async function () { // 9:00
    try {
...
crontab.scheduleJob("00 0 13 * * 1-5", async function () { // 13:00
    try {
...
crontab.scheduleJob("00 0 19 * * 1-5", async function () { // 19:00
    try {
...
crontab.scheduleJob("00 0 22 * * 1-5", async function () { // 22:00
    try {
